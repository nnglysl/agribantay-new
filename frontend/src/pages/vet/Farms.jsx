  ...
  return (
    <VetLayout>
      ...
      <p style={styles.subtitle}>
        All Registered Farms and Owners
      </p>
      ...
      <div style={{ ...styles.toolbar, ...(isMobile ? styles.toolbarMobile : {}) }}>
        <div style={styles.searchWrap}>
          ...
          <input
            placeholder="Search farm, owner, or barangay..."
            value={search}
                  ...
                  <tr key={f.id} style={styles.tr}>
                    ...
                    <td style={styles.td}>
                      <div style={{ minWidth: 0 }}>
                        <div style={styles.farmName}>{f.farm_name}</div>
                        <div style={styles.ownerName}>{f.owner_name}</div>
                      </div>
                    </td>
                    ...
                    <td style={{ ...styles.td, textAlign: 'right' }}>
                      <span style={styles.viewBtn} onClick={() => navigate(`/vet/farms/${f.id}`)}>View</span>
                    </td>
                  </tr>
                ))}
              </tbody>
...
const styles = {
  ...
  avatarImg: { width: '38px', height: '38px', borderRadius: '10px', objectFit: 'cover', display: 'block', flexShrink: 0 },
  farmName: { fontWeight: 700, color: '#16311d', fontSize: '13.5px' },
  ownerName: { fontSize: '12.5px', color: '#8a968d', marginTop: '1px' },
  viewBtn: {
