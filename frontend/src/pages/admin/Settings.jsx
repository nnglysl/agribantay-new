...
export default function Settings() {
  ...
  const handleProfileSave = async (e) => {
    ...
    try {
      ...
      const res = await api.post('/settings/profile', formData, {
      ...
      setProfile({
        ...
        email: email || null,
        profile_photo_url: res.data.data.profile_photo_path
          ? profile.profile_photo_url // will refresh on next full reload; keep existing preview meanwhile
  ...
  if (!profile) return <AdminLayout><p>Loading...</p></AdminLayout>
