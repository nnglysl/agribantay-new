...
export default function VetLayout({ children }) {
  ...
  const navItems = [
    ...
    { label: 'Vaccination Requests', path: '/vet/vaccination-requests' },
    { label: 'Reports', path: '/vet/reports' },
    { label: 'Settings', path: '/vet/settings' },
  ]
  ...
  return (
    <div style={styles.wrapper}>
      <aside style={styles.sidebar} className="no-print">
        ...
        <div style={styles.sectionLabel}>VETERINARIAN</div>
